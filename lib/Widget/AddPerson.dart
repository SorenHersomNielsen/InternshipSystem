    ...
    return Scaffold(
        body: Padding(padding: const EdgeInsets.all(20.0),
          ...
          child: Column(children: <Widget>[
            ...
            TextFormField(
              decoration: const InputDecoration(
                  border: OutlineInputBorder(), labelText: 'Telefonnummer'),
              onChanged: (value) {
            ...
            TextButton(
              ...
              onPressed: () {
                if (_formKey.currentState!.validate()) {
                  print('tryk');
                  NetworkMethod.createPerson(_name, _mail, _password, _telephoneNumber, _internship, _school, dropdownValue).then((value) => {
                    if(value != null){
